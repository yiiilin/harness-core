...
type InteractiveReopenResult = hruntime.InteractiveReopenResult
type InteractiveViewRequest = hruntime.InteractiveViewRequest
type InteractiveViewResult = hruntime.InteractiveViewResult
type InteractiveWriteRequest = hruntime.InteractiveWriteRequest
type InteractiveWriteResult = hruntime.InteractiveWriteResult
type InteractiveCloseRequest = hruntime.InteractiveCloseRequest
type InteractiveCloseResult = hruntime.InteractiveCloseResult
type ArtifactReadRequest = hruntime.ArtifactReadRequest
type ArtifactReadResult = hruntime.ArtifactReadResult
...
type InteractiveController = hruntime.InteractiveController
...
const (
	...
	ExecutionAggregateMetadataKeyMaxConcurrency = execution.AggregateMetadataKeyMaxConcurrency
